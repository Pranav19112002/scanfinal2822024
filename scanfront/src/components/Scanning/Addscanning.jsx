...
function Addscanning() {
  ...
  return (
    <div className="form-container">
      {loading && <Loader />}
      {error && <Error message="Erorr Occurred"/>}
      ...
      <Box height={20}>
        <Box sx={{ display: 'flex' }}>
          ...
          <Grid className='grid-container10'>
            <Paper elevation={10} className='paperstyle10' style={{ backgroundImage: `url(${logcoverImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
